...
export class HomePage {
  ...
  public options: Array<any> = [
    ...
    {icon: 'phone-portrait-outline',text: 'Recarrega de celular'},
    {icon: 'wallet-outline',text: 'Depositar'},
    {icon: 'options-outline',text: 'Ajustar limite'},
    {icon: 'help-circle-outline',text: 'Me ajuda'},
    {icon: 'barcode-outline',text: 'Pagar'},
    {icon: 'lock-open-outline',text: 'Bloqueio Temporario'},
  ...
  {icon: 'cash-outline', text: 'Configuração Conta'},
  {icon: 'card-outline', text: 'Configuração Perfil'},
  {icon: 'phone-portrait-outline', text: 'Configurar App  '}
